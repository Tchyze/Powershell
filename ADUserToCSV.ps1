...
$users | Select-Object DisplayName, GivenName, SurName, Mail, Title, Department, HomePhone, OfficePhone, MobilePhone, Fax, StreetAddress, City, PostalCode, State, Country, Office, Company, wWWHomePage | Export-Csv -Path $ExportPath -NoTypeInformation -Encoding UTF8